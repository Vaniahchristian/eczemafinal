...
import DoctorNavbar from "@/components/layout/doctor-navbar"
...
export default function DoctorLayout({
  ...
  return (
    <div className="min-h-screen bg-blue-50 dark:bg-slate-900 flex flex-col doctor-bg">
      <DoctorNavbar onMenuClick={() => setSidebarOpen(!sidebarOpen)} />
